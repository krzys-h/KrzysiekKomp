...
kernel: loader main.c
	...
	ld -melf_i386 -T linker.ld -o ./bin/kernel.bin ./bin/loader.o ./bin/main.o ./bin/commands.o ./bin/vga.o ./bin/gdt.o ./bin/gdt_asm.o ./bin/idt.o ./bin/idt_asm.o ./bin/exception.o ./bin/exception_asm.o ./bin/keyboard.o ./bin/keyboard_asm.o ./bin/clock.o ./bin/clock_asm.o ./bin/power_asm.o ./bin/pisz.o ./bin/cmos.o ./bin/mouse.o
